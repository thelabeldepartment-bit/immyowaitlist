...
export function HeroWaitlist() {
  ...
  return (
    <div className="w-full max-w-xl mx-auto flex flex-col items-center text-center">
      {/* Badge */}
      <div className="inline-flex items-center gap-1.5 md:gap-2 bg-white/15 backdrop-blur-md text-white text-[10px] md:text-[11px] font-semibold px-3 py-1.5 md:px-4 md:py-2 rounded-full mb-7 md:mb-8 border border-white/30 tracking-[0.1em] md:tracking-[0.12em] uppercase shadow-md">
      ...
      {/* Headline */}
      <h1
        className="text-[30px] sm:text-[36px] md:text-6xl font-extrabold text-white leading-[1.18] md:leading-[1.06] tracking-tight mb-6 md:mb-5 max-w-3xl"
      ...
      {/* Subtitle */}
      <p
        className="text-sm md:text-lg font-medium text-white/90 mb-9 md:mb-10 max-w-lg leading-relaxed"
